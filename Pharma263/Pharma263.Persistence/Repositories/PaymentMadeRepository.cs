...
{
    public class PaymentMadeRepository : Repository<PaymentMade>, IPaymentMadeRepository
    {
        public PaymentMadeRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}

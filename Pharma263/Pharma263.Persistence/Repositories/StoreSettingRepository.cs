...
{
    public class StoreSettingRepository : Repository<StoreSetting>, IStoreSettingRepository
    {
        public StoreSettingRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
        }
    }
}

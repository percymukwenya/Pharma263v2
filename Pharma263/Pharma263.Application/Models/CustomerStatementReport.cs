...
namespace Pharma263.Application.Models
{
    public class CustomerStatementReport
    {
        ...
        public CustomerStatementViewModel _model;
        ...
        public byte[] CreateReport(CustomerStatementViewModel model)
        {
            _model = model;
        ...
        private void reportHeader()
        {
            ...
            _pdfPCell = new PdfPCell(new Phrase("CUSTOMER ACCOUNT STATEMENT", _fontStyle));
            _pdfPCell.Colspan = 2;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 9f, 0);
            _pdfPCell = new PdfPCell(new Phrase(_model.Statement.CustomerName, _fontStyle));
            _pdfPCell.Colspan = 1;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void accountSummary()
        {
            ...
            _pdfPCell = new PdfPCell(new Phrase("Total Charges", _fontStyle));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            ...
            _pdfPCell = new PdfPCell(new Phrase("Current Balance", _fontStyle));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.Border = Rectangle.LEFT_BORDER | Rectangle.RIGHT_BORDER;
            _pdfPCell.Padding = 5f;
            summaryTable.AddCell(_pdfPCell);
        ...
        private void reportBody()
        {
            ...
            _pdfPCell = new PdfPCell(new Phrase("Charges", _fontStyle));
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.LIGHT_GRAY;
            _pdfPTable.AddCell(_pdfPCell);

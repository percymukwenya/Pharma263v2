...
namespace Pharma263.Application.Models
{
    public class QuotationReport
    {
        ...
        public QuotationReportViewModel _model;
        ...
        public byte[] CreateReport(QuotationReportViewModel model)
        {
            _model = model;
            ...
            _document.Open();
            _pdfPTable.SetWidths(new float[] { 40f, 150f, 80f, 80f, 80f, 80f, 80f });
        ...
        private void reportHeader()
        {
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 9f, 0);
            _pdfPCell = new PdfPCell(new Phrase(_model.Quotation.QuotationDate.DateTime.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture), _fontStyle));
            _pdfPCell.Colspan = 1;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
        ...
        private void reportBody()
        {
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, 1);
            _pdfPCell = new PdfPCell(new Phrase("PRODUCT LIST REQUESTED BY CUSTOMER", _fontStyle));
            _pdfPCell.Colspan = _totalColumn;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _pdfPCell.Border = 0;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            _pdfPCell = new PdfPCell(new Phrase(_model.Company.Currency + _model.Quotation.Total.ToString("### ###0.00", CultureInfo.InvariantCulture), _fontStyle));
            _pdfPCell.Border = 0;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            _pdfPCell = new PdfPCell(new Phrase(_model.Company.Currency + _model.Quotation.Discount.ToString("### ###0.00", CultureInfo.InvariantCulture), _fontStyle));
            _pdfPCell.Border = 0;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            _pdfPCell = new PdfPCell(new Phrase(_model.Company.Currency + _model.Quotation.GrandTotal.ToString("### ###0.00", CultureInfo.InvariantCulture), _fontStyle));
            _pdfPCell.Border = 0;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            _pdfPCell = new PdfPCell(new Phrase(_model.Quotation.QuotationStatus.ToString(), _fontStyle));
            _pdfPCell.Border = 0;
            _pdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _pdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _pdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            bankingDetailsContentCell.Colspan = 1; // This cell spans one column
